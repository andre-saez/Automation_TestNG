...
public class PerformanceTesting {
	...
	static org.testng.log4testng.Logger log = Logger.getLogger(PerformanceTesting.class);

	@BeforeClass
	public void beforeClass() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		// System.setProperty("webdriver.gecko.driver","/Users/DesktopW7/Documents/workspace_personal/selenium/geckodriver");
